          ...
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="order in myOrder.records" :key="order.id">
                ...
                <tbody>
                  <tr v-for="(goods,index) in order.orderDetailList" :key="goods.skuId">
                    <td width="60%">
                      <div class="typographic">
                        <img style="width:82px;height:82px" :src="goods.imgUrl">
...
<PageNation :pageNo='page' :pageSize='limit' :totle='myOrder.total' :continues='5' @getPageNo='getPageNo'/>
